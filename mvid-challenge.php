<?php
  ...
  function registerSessionUsage($mv_session_hash,$domain,$shared_key,&$mv_session_id,&$error_message) {
    // Connect to MV-ID's session security service to register a valid application session
    $client = new JsonWspClient("https://signon.mv-nordic.com/session-security/SessionSecurity/jsonwsp/description");
